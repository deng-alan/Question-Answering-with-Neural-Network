...
def check(target_values, predicted_values):
...
def main():
    ...
    parser.add_argument('tagged_dataset_path',
            help='Path to the CoreNLP-tagged dataset TSV file')
    parser.add_argument('prediction_path',
            help='Path to the prediction file. Each line contains '
                 'ex_id <tab> item1 <tab> item2 <tab> ...')
    args = parser.parse_args()
    
    print >> sys.stderr, 'Reading dataset from', args.tagged_dataset_path
    # ID string --> list[Value]
    target_values_map = {}
    with open(args.tagged_dataset_path, 'r', 'utf8') as fin:
    ...
    with open(args.prediction_path, 'r', 'utf8') as fin:
        for line in fin:
            ...
            correct = check(target_values, predicted_values)
